...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FilterBase.crossref'
        db.add_column('feedjack_filterbase', 'crossref',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FilterBase.crossref'
        db.delete_column('feedjack_filterbase', 'crossref')
