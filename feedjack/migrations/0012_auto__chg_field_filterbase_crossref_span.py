...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FilterBase.crossref_span'
        db.alter_column('feedjack_filterbase', 'crossref_span', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'FilterBase.crossref_span'
        db.alter_column('feedjack_filterbase', 'crossref_span', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0))
