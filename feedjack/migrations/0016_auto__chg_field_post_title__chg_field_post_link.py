...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('feedjack_post', 'title', self.gf('django.db.models.fields.CharField')(max_length=2047))

        # Changing field 'Post.link'
        db.alter_column('feedjack_post', 'link', self.gf('django.db.models.fields.URLField')(max_length=2047))

    def backwards(self, orm):

        # Changing field 'Post.title'
        db.alter_column('feedjack_post', 'title', self.gf('django.db.models.fields.CharField')(max_length=511))
