...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('feedjack_post', 'date_updated')


        # Changing field 'Post.date_created'
        db.alter_column('feedjack_post', 'date_created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

    def backwards(self, orm):
        # Adding field 'Post.date_updated'
        db.add_column('feedjack_post', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(1970, 1, 1, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'Post.date_created'
        db.alter_column('feedjack_post', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
