...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FilterBase.crossref_span'
        db.add_column('feedjack_filterbase', 'crossref_span',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Tag.name'
        db.alter_column('feedjack_tag', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=127))

        # Changing field 'Feed.etag'
        db.alter_column('feedjack_feed', 'etag', self.gf('django.db.models.fields.CharField')(max_length=127))

    def backwards(self, orm):
        # Deleting field 'FilterBase.crossref_span'
        db.delete_column('feedjack_filterbase', 'crossref_span')


        # Changing field 'Tag.name'
        db.alter_column('feedjack_tag', 'name', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True))

        # Changing field 'Feed.etag'
        db.alter_column('feedjack_feed', 'etag', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        'feedjack.filterbase': {
            ...
            'crossref_span': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
