...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post._enclosures'
        db.add_column('feedjack_post', '_enclosures',
                      self.gf('django.db.models.fields.TextField')(default='', db_column='enclosures', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post._enclosures'
        db.delete_column('feedjack_post', 'enclosures')
