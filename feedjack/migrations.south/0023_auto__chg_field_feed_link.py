...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('feedjack_feed', 'link', self.gf('django.db.models.fields.URLField')(max_length=511))

    def backwards(self, orm):

        # Changing field 'Feed.link'
        db.alter_column('feedjack_feed', 'link', self.gf('django.db.models.fields.URLField')(max_length=200))
